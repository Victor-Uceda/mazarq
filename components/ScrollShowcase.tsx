...
const scenes = [
  {
    title: "Recepciones",
    text: "Primera impresion, recorrido y escala para espacios comerciales o eventos.",
    metric: "01"
  },
  {
    title: "Interiores",
    text: "Materiales, iluminacion y composicion para presentar ambientes con decision.",
    metric: "02"
  },
  {
    title: "Instalaciones",
    text: "Volumenes efimeros, piezas espaciales y visuales para propuestas memorables.",
    metric: "03"
  }
];
      ...
      <div className="mx-auto grid w-full max-w-[1760px] gap-10 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
        <div className="max-w-4xl lg:sticky lg:top-[10rem]">
          ...
          <p className="mt-6 text-base leading-7 text-black/58 sm:mt-7 sm:text-lg sm:leading-8">
            Modelado, render y direccion visual para presentar propuestas con
            claridad, atmosfera y valor comercial.
          </p>
        </div>
        ...
        <div className="grid gap-4">
          {scenes.map((scene, index) => (
            ...
            >
              <p className="text-[9px] font-semibold uppercase tracking-[0.3em] text-black/38 sm:text-[10px]">
                {scene.metric}
              </p>
