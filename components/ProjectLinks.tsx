...
/** Project gallery – two image cards linking to Instagram, with
 *  a section heading and a "Ver Instagram" CTA. */
        ...
        <div className="absolute bottom-8 left-8 right-8">
          <div className="glass-surface rounded-[1.6rem] p-4 sm:rounded-[2.6rem] sm:p-6">
            <div className="flex items-end justify-between gap-5">
              <h3 className="display text-3xl leading-none text-[#111] sm:text-5xl">{project.title}</h3>
              <span className="text-[10px] font-bold uppercase tracking-[0.24em] text-black/48">Abrir</span>
            </div>
          </div>
        </div>
      </a>
    ...
    <section id="proyecto" className="relative z-10 px-5 py-24 sm:px-8 lg:px-12">
      <div className="mx-auto max-w-[1760px]">
        <Reveal className="mb-14 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.42em] text-black/42">Proyectos reales</p>
